...
//   // Reset state when question changes to avoid pre-answered/stuck UI
//   useEffect(() => {
...
//     // Beri tahu parent bahwa soal sudah dijawab
//     onAnswer(isCorrect);
//   };
...
//         // Tambahkan ke pasangan yang sudah cocok dan cek penyelesaian
//         setMatchedPairs(prev => {
//           const next = [...prev, { ...selectedPair }];
//           if (question.pairs.length > 0 && next.length === question.pairs.length) {
//             setIsCompleted(true);
//           }
//           return next;
//         });
...
//   // Tandai selesai jika semua pasangan sudah dicocokkan
//   useEffect(() => {
//     if (question.pairs.length > 0 && matchedPairs.length === question.pairs.length) {
//       setIsCompleted(true);
//       if (!notifiedCompleteRef.current) {
//         notifiedCompleteRef.current = true;
//         // Beri tahu parent bahwa soal sudah siap dilanjutkan
//         onAnswer(true);
//       }
//     }
//   }, [matchedPairs.length, question.pairs.length, onAnswer]);
...
//           className="mt-6 w-full py-3 rounded-lg bg-orange-500 text-white text-lg font-semibold shadow-md"
//         >
//           LANJUTKAN
//         </button>
//       )}
...
//       setScore(score + 1);
//     }
//     // Izinkan lanjut ke soal berikutnya via tombol
//     setCanProceed(true);
//   };
